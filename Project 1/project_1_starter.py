...
def get_top_n(prev_returns, top_n):
    ...
    return_stocks = pd.DataFrame(0, index = prev_returns.index, columns = prev_returns.columns)
    
    for index, r in prev_returns.iterrows():
        top_stocks = r.nlargest(top_n).index
        return_stocks.loc[index, top_stocks] = 1
...
def portfolio_returns(df_long, df_short, lookahead_returns, n_stocks):
    ...
    """
    portfolio_long_short = df_long - df_short

    return portfolio_long_short * (lookahead_returns/n_stocks)
